  ...
  return (
    <div className="max-w-md mx-auto mt-10 p-6 rounded-2xl shadow-lg bg-white dark:bg-zinc-900 text-zinc-800 dark:text-zinc-100 space-y-6 transition-all duration-300">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        />
        <Button onClick={handleSubscribe} variant="default" className="gap-1">
      ...
      <a href="/CV_ATUAL.pdf" download>
        <Button
          variant="default"
          className="w-full flex items-center justify-center gap-2 rounded-xl h-10 transition-all hover:bg-blue-600 dark:hover:bg-blue-500"
        >
          <Download />
          Baixar Currículo
        </Button>
